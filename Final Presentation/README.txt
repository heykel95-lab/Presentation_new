...
2026-09-22: Removed B5 Joint motion: all individual trials at the user's request. Its original slide and notes are archived, with all figure assets and source data retained. The current deck has 26 main slides and seven hidden backups at physical slides 27–33. Both PDFs are updated: 33 pages in Thesis_Defense_gg0_v3.pdf and seven in Supplementary_slides.pdf. The backup order is B1 Opposing moment, B2 Null-space torques and projector, B3 Cumulative joint motion: all settings, B4 Jacobian conditioning: all settings, B5 Angular quantities, B6 Baseline angular error, B7 Sources of angular offset. Remaining content, notes, videos, equations and speaking files are unchanged. These counts and positions supersede the historical records below. See ../experiments/nullspace_narrative/individual_trials_removed_20260922.json.
