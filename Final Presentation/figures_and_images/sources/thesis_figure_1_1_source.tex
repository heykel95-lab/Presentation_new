...
% Retain the original canvas so trimming the surfaces does not move or resize
% the legend, tool, angle markers, or surrounding thesis content.
\pgfresetboundingbox
\begin{scope}[reset cm]
  \path[use as bounding box] (-110.1638pt,-36.23709pt)
    rectangle (258.45518pt,80.31772pt);
\end{scope}
\end{tikzpicture}
